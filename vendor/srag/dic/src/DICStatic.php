...
namespace srag\DIC\MetaData;

use ilLogLevel;
use ilPlugin;
use srag\DIC\MetaData\DIC\DICInterface;
use srag\DIC\MetaData\DIC\Implementation\ILIAS52DIC;
use srag\DIC\MetaData\DIC\Implementation\ILIAS53DIC;
use srag\DIC\MetaData\DIC\Implementation\ILIAS54DIC;
use srag\DIC\MetaData\DIC\Implementation\ILIAS60DIC;
use srag\DIC\MetaData\DIC\Implementation\LegacyDIC;
use srag\DIC\MetaData\Exception\DICException;
use srag\DIC\MetaData\Output\Output;
use srag\DIC\MetaData\Output\OutputInterface;
use srag\DIC\MetaData\Plugin\Plugin;
use srag\DIC\MetaData\Plugin\PluginInterface;
use srag\DIC\MetaData\Version\Version;
use srag\DIC\MetaData\Version\VersionInterface;

/**
 * Class DICStatic
 *
 * @package srag\DIC\MetaData
 *
